...
export const estimateLayoutConfig = [
  // セクション1: 見積基本情報 
  {
    ...
    fields: [
      ...
      { 
        ...
        element: <Badge bg="warning" text="dark">下書き</Badge>
      },
    ]
  },
  ...
  // セクション3: 明細 (入力欄あり) 
  {
    ...
    fields: [
      ...
      { key: 'amount', label: '金額', type: 'text', headerStyle: { width: '150px' }, style: { textAlign: 'right', fontWeight: 'bold' } },
    ]
  },
  ...
  //  セクション4: 合計金額など 
  {
    ...
    fields: [
      ...
      { key: 'total', label: '合計金額', type: 'text', style: { textAlign: 'right', fontWeight: 'bold', fontSize: '1.1em' } },
    ]
  },
